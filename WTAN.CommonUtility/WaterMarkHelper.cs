...
namespace WTAN.CommonUtility
{
    public class WaterMarkHelper
    {
        ...
        public static void DrawImage(ImageWatermarkParameters parameters, out string errorMsg)
        {
            ...
            try
            {
                ...
                SaveAs(finalImage, parameters.SourceImagePath);
        ...
        /// <returns></returns>
        public static void DrawText(TextWatermarkParameters parameters, out string errorMsg)
        {
            errorMsg = string.Empty;
        ...
        private static void SaveAs(Bitmap img, String imgpath)
        {
        ...
        private static EncoderParameters GetEncoderParameters()
        {
            ...
            EncoderParameter ep = new EncoderParameter(System.Drawing.Imaging.Encoder.Quality, _imageSaveQualityValue);
            eps.Param[0] = ep;
        ...
        public struct ImageWatermarkParameters
        {
            ...
            public bool CheckAndSetDefault(out string errorMsg)
            {
                ...
                if ((string.IsNullOrEmpty(this.SourceImagePath) && SourceImageStream == null)
                    ...
                    || (SourceImageStream != null && string.IsNullOrEmpty(SourceImageFileExtensionName))
                ...
                {
                    if ((SourceImageFileExtensionName != ".gif" && SourceImageFileExtensionName != ".jpg" && SourceImageFileExtensionName != ".png"))
                        validExName = false;
                }
                else
                    validExName = false;
